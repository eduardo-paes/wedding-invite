    ...
    <div className="main-container folheto">
      ...
      <section id="liturgia-palavra" className="fol-body">
        ...
        <Leitura
          ...
          antifon={
            "Sobretudo, amai-vos uns aos outros, pois o amor é o vínculo da perfeição."
          }
      ...
      <section id="ritos-matrimoniais" className="fol-body">
        ...
        <Especifico
          text="Caros noivos, Eduardo e Giovana, 
        ...
        <Especifico
          ini="Noivo: "
          text="Eu, Eduardo te recebo, Giovana, por minha esposa e te prometo ser fiel amar-te e respeitar-te na alegria e na tristeza, na saúde e na doença, todos os dias da nossa vida."
        />
        <Especifico
          ini="Noiva: "
          text="Eu, Giovana te recebo, Eduardo, por meu esposo e te prometo ser fiel, amar-te e respeitar-te na alegria e na tristeza, na saúde e na doença, todos os dias na nossa vida."
        />
        ...
        <Especifico
          ini="Esposo: "
          text="Giovana, recebe esta aliança em sinal do meu amor e da minha fidelidade. Em nome do Pai, e do Filho e do Espírito Santo."
        />
        <Especifico
          ini="Esposa: "
          text="Eduardo, recebe esta aliança em sinal do meu amor e da minha fidelidade. Em nome do Pai, e do Filho e do Espírito Santo."
        />
        ...
        <Especifico
          ini="1. "
          text="Para que estes nossos irmãos Eduardo e Giovana agora santamente unidos em matrimônio, possam gozar de saúde e paz, rezemos ao Senhor."
        />
